...
import { X, ChefHat, MessageCircle, Loader2 } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { toast } from "sonner";

interface TraiteurFormDialogProps {
  open: boolean;
  onClose: () => void;
}
        ...
        >
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-primary/20 via-primary/10 to-accent/10 border-b border-primary/15 px-6 py-6 sm:py-7 text-center">
              ...
              <ChefHat className="mx-auto text-primary mb-3" size={40} />
...
export default TraiteurFormDialog;
